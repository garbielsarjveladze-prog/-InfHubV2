-- [[ Redz Library V2 - The layout from your image ]] --
...
-- 🌐 SERVER TAB
-- ==========================================
local ServerTab = Window:MakeTab({"Server", "rbxassetid://4483345998"})
...
-- 🏃 MOVEMENT TAB
-- ==========================================
local MoveTab = Window:MakeTab({"Movement", "rbxassetid://4483345998"})
...
-- 👁️ VISUAL TAB
-- ==========================================
local VisualTab = Window:MakeTab({"Visual", "rbxassetid://4483345998"})
...
-- 🎭 FUN TAB
-- ==========================================
local FunTab = Window:MakeTab({"Fun", "rbxassetid://4483345998"})
...
-- 👤 LOCAL PLAYER TAB
-- ==========================================
local LPTab = Window:MakeTab({"Local Player", "rbxassetid://4483345998"})

LPTab:AddToggle({
  Name = "Freeze Character",
  Default = false,
  Callback = function(v) 
    if player.Character:FindFirstChild("HumanoidRootPart") then player.Character.HumanoidRootPart.Anchored = v end
  end
})
...
-- [[ Backend Handling - Do Not Change ]] --
